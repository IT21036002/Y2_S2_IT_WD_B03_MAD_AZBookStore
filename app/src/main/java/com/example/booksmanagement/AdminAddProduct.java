...
public class AdminAddProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText1 = (EditText)findViewById(R.id.cbode);
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
            ...
            storageReference2nd.putFile(FilePathUri)
                            ...
                            taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(
                                    new OnCompleteListener<Uri>() {
                                        ...
                                        public void onComplete(@NonNull Task<Uri> task) {
                                            ...
                                            if (code.isEmpty()) {
                                                editText1.setError("Book Code is required");
                                            }else if (name.isEmpty()) {
                                                editText2.setError("Book Name is required");
                                            }else if (price.isEmpty()) {
                                                editText3.setError("Book Price is required");
                                            }else if (description.isEmpty()) {
                                                editText4.setError("Book Description is required");
                                            }else {
                                                ...
                                                BookDetails products = new BookDetails(key, fileLink, code, name, price, description);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(AdminAddProduct.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(AdminAddProduct.this, "Failed", Toast.LENGTH_LONG).show();
